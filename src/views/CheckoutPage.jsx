...
export default function CheckoutPage() {
  ...
  const { cartItems, handleCheckout: onCheckout, checkoutStatus, formatPrice, paymentMethod, setPaymentMethod: onPaymentMethodChange, orderNote, handleOrderNoteChange: onOrderNoteChange } = useCart()
  const isDevUser = isAdmin
