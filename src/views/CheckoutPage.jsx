...
const stripeAppearance = {
  ...
  variables: {
    ...
    colorIconCardCvc: '#fbbf24',
    colorIconCardCvcError: '#ef4444',
    fontFamily: 'Inter, Segoe UI, system-ui, sans-serif',
    fontSizeBase: '15px',
    spacingUnit: '4px',
    borderRadius: '8px',
    focusBoxShadow: '0 0 0 3px rgba(251, 191, 36, 0.2)',
    focusOutline: 'none',
  },
  rules: {
    '.Label': { color: '#94a3b8', fontSize: '13px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '6px' },
    '.Input': { border: '1px solid rgba(251, 191, 36, 0.25)', backgroundColor: 'rgba(255,255,255,0.05)', padding: '12px 14px', color: '#f1f5f9' },
    '.Input:focus': { border: '1px solid rgba(251, 191, 36, 0.7)', boxShadow: '0 0 0 3px rgba(251,191,36,0.12)' },
    '.Input--invalid': { border: '1px solid rgba(239,68,68,0.7)', boxShadow: '0 0 0 3px rgba(239,68,68,0.12)' },
    '.Error': { color: '#ef4444', fontSize: '13px' },
    '.Tab': { border: '1px solid rgba(255,255,255,0.08)', backgroundColor: 'rgba(255,255,255,0.03)', color: '#94a3b8' },
    '.Tab:hover': { backgroundColor: 'rgba(251,191,36,0.06)', color: '#f1f5f9' },
    '.Tab--selected': { border: '1px solid rgba(251,191,36,0.5)', backgroundColor: 'rgba(251,191,36,0.1)', color: '#fbbf24' },
    '.TabIcon--selected': { fill: '#fbbf24' },
    '.TabLabel--selected': { color: '#fbbf24' },
    '.CheckboxInput': { border: '1px solid rgba(251,191,36,0.3)', backgroundColor: 'rgba(255,255,255,0.05)' },
    '.CheckboxInput--checked': { backgroundColor: '#fbbf24', borderColor: '#fbbf24' },
  },
}
